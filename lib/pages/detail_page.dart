...
class DetailPage extends StatefulWidget {
  ...
  final List<InvoiceCourse>? invoiceCourses;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Padding(
          padding:
              const EdgeInsets.only(right: 8.0, left: 8, top: 8, bottom: 85),
          child: Material(
            elevation: 6,
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CoursesTable(
                    ...
                    invoiceCourses: widget.invoiceCourses!.asMap(),
