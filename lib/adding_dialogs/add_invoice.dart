      ...
      onTapAdd: () async {
        if (_formKey.currentState!.validate()) {
          ...
          selectedCourses.forEach(
              (_, value) => coursesSubtotal = coursesSubtotal + value.amount);
                  ...
                  children: [
                    ...
                    for (int i = 0; i < numberOfCourses; i++) ...[
                      DropdownCourseTile(
                                  ...
                                  listViewBuilder: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return DropdownItemTile(
                                          currentMenuIndex: index,
                                          itemText:
                                              "#${item.courseId}- ${item.name}\n\$${item.cost}/${item.costFrequency} - ${item.quantity}x,\nTotal: \$${item.amount}",
                                          lastItemIndex:
                                          ...
                                          onItemTap: () {
                                            ...
                                            courseControllers[i].text =
                                                "#${item.courseId}- ${item.name}, \$${item.cost}/${item.costFrequency} - ${item.quantity}x,Total: \$${item.amount}";
                        ...
                        onTapAdd: selectedCourses[i] == null ||
                                numberOfCourses != i + 1
                            ? null
                            : () {
                                onTapAddCourse = true;
                        ...
                        onTapRemove: numberOfCourses != i + 1
                            ? null
                            : () {
                                courseControllers[i].clear();

                                courseMenuItems.add(selectedCourses[i - 1]!);

                                courseMenuItems.sort(
                                    (a, b) => a.courseId.compareTo(b.courseId));
